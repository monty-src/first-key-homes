...
**Tenants:** Nia Tara Byrd & Montier Elliott
...
- ✅ Senior VP at Bank of America (Montier Elliott)
...
- 🚨 **70+ hours** without functional heat in winter (57°F indoors)
...
```mermaid
graph TD
    A["FirstKey Homes<br/>Legal Case"] --> B["Critical Issues"]
    A --> C["Violations"]
    A --> D["Damages"]

    B --> B1["Water Leak<br/>5+ months"]
    B --> B2["No Heat<br/>70+ hours"]
    B --> B3["Broken Promises<br/>Multiple"]

    C --> C1["N.C.G.S. § 42-42<br/>Habitability"]
    C --> C2["N.C.G.S. § 42-38<br/>Maintenance"]
    C --> C3["N.C.G.S. § 75-1.1<br/>Unfair Practices"]
...
| **Tenants** | Nia Tara Byrd & Montier Elliott |
| **Rent** | $2,855/month |
| **Tenancy** | 3 years (2022-present) |
| **Status** | PREPARING LEGAL ACTION |

## Critical Issues

| Issue | Duration | Status | Impact |
|-------|----------|--------|--------|
| **Water Leak** | 5+ months | UNRESOLVED | $1,500+ cost |
| **Heating Failure** | 70+ hours | EMERGENCY | Child endangered |
| **Broken Promises** | 73+ days | PATTERN | Multiple failures |

## Settlement Timeline

- **Deadline**: December 13, 2025, 8:00 PM
- **Action**: Lawsuit filing December 16 (if no settlement)
- **Demand**: $35,000 primary offer
- **Minimum**: $25,000 + repairs + lease termination

## Damages Summary

```
Actual Damages:          $49,070
Treble (3x) Damages:   $147,210
With Attorney Fees:    $160,000+
Maximum Exposure:      $244,770+
```
...
- ✅ Perfect 3-year payment history (never late)
- ✅ Montez: SVP at Bank of America
- ✅ Nia: Software Engineer
- ✅ 3-year-old daughter in home
- ✅ Professional, responsible tenants
...
- ✅ Water bills showing 580% increase
- ✅ Temperature logs (70+ hours at 57°F)
- ✅ Photos/videos dated
- ✅ Communication log (73+ days)
- ✅ Vendor reports (HVAC needs replacement)
- ✅ Payment records
...
1. Send final demand letter (48-hour deadline)
2. Establish rent escrow
3. Document all evidence
4. Consult with attorney
5. File regulatory complaints if no settlement
6. Prepare court filing if needed
